 ...
 *         regarding only letter multipliers if they are of "simple" type
 */
public class SimpleAdder implements AdderImplementor
{
	/**
	 * Gives the value of the given tile multiplied by 1
	 *
